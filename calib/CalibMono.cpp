...
int main()
{
    ...
    std::string filePath = "../cfg/CalibMono.xml";
    ...
    cv::Size board_size = cv::Size(12, 8);                   // 标定板上每行、列的角点数
    ...
    //棋盘三维信息
    cv::Point2f square_size = cv::Point2f(41.45, 41.45);  // 实际测量得到的标定板上每个棋盘格的大小
